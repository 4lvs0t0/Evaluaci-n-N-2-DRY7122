...
key = "4ea23df1-381b-447d-aac6-fc31ccec939d"      # Replace with your Graphhopper API key
...
def geocoding (location, key):
    ...
    if json_status == 200 and len(json_data["hits"]) !=0:
        ...
        print("URL de la API de geocodificación para " + new_loc + " (tipo de locacion: " + value + ")\n" + url)
    else:
        lat="null"
        lng="null"
        new_loc=location
...
while True:
    ...
    if orig[0] == 200 and dest[0] == 200:
        ...
        print("=================================================")
        print("Direcciones desde" + orig[3] + " to " + dest[3] + " by " + vehicle)
        print("=================================================")
        if paths_status == 200:
            ...
            print("Distancia viajada: {1:.2f} km".format(km))
